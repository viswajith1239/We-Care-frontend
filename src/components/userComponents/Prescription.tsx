...
pdf.text(`Consultation Date: ${new Date(prescriptionData.bookingDate || bookingData.bookingDate).toLocaleDateString()}`, 20, yPosition + 16)
            ...
            <table className="w-full border-collapse rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-gray-50">
                  <th className="py-2 px-4 bg-[#00897B] text-white">Doctor</th>
                  ...
                  <th className="py-2 px-4 bg-[#00897B] text-white">Duration</th>
                   <th className="py-2 px-4 bg-[#00897B] text-white">instructions</th>
