          ...
          <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-md shadow-lg rounded-md bg-white">
            ...
            <div className="space-y-4">
              ...
              <div className="border-b pb-2">
                ...
                <p className="text-lg text-gray-900">{new Date(selectedBooking.bookingDate).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}</p>
              ...
              <div className="border-b pb-2">
                ...
                <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(selectedBooking.appoinmentStatus || 'pending')}`}>
